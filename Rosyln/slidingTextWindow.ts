...
namespace Microsoft.CodeAnalysis.CSharp.Syntax.InternalSyntax
{
    ...
    /// </summary>
    private class SlidingTextWindow implements IDisposable
    {
        /// <summary>
        ...
        /// </summary>
        public const InvalidCharacter: string = "\uFFFF";

        private const DefaultWindowLength: number = 2048;

        private readonly SourceText _text;                 // Source of text to parse.
        private _basis: number;                                // Offset of the window relative to the SourceText start.
        private _offset: number;                               // Offset from the start of the window.
        private readonly _textEnd: number;                     // Absolute end position
        private _characterWindow: string;                   // Moveable window of chars from source text
        private _characterWindowCount: number;                 // # of valid characters in chars buffer
