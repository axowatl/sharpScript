...
namespace System {
    ...
    public class bool implements IComparable, IConvertible, IComparable<Boolean>,  IEquatable<Boolean>
    {
    
      //
      // Member Variables
      //
      private m_value: bool;
 
      // The true value. 
      // 
      private const True: int = new int(1); 
      
      // The false value.
      // 
      private const False: int = new int(0);
