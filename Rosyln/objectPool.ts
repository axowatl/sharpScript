...
namespace Microsoft.CodeAnalysis.PooledObjects
{
    ...
    /// </summary>
    private interface PoolElement<T> {
        value: T | null;
    }
    ...
    class ObjectPool<T>
    {
        ...
        private readonly _items: PoolElement<T>[];
        ...
        public readonly TrimOnFree: boolean;

        private static readonly ConditionalWeakTable<T, LeakTracker> leakTrackers = new ConditionalWeakTable<T, LeakTracker>();
        private static leakTrackers = new WeakMap<T, LeakTracker>();
